...
namespace AdventOfCode2020.DailyChallenges.Day16
{
    public class ChallengeDay16 : IAdventCodeDayChallenge
    {
        private readonly IDataProvider<int> _dataProvider;
        private readonly TextWriter _output;

        public ChallengeDay16(IDataProvider<int> dataProvider, TextWriter output)
        {
