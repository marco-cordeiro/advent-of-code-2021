...
namespace AdventOfCode2020.DailyChallenges.Day24
{
    public class ChallengeDay24 : IAdventCodeDayChallenge
    {
        private readonly IDataProvider<int> _dataProvider;
        private readonly TextWriter _output;

        public ChallengeDay24(IDataProvider<int> dataProvider, TextWriter output)
        {
