...
namespace AdventOfCode2020.DailyChallenges.Day18
{
    public class ChallengeDay18 : IAdventCodeDayChallenge
    {
        private readonly IDataProvider<int> _dataProvider;
        private readonly TextWriter _output;

        public ChallengeDay18(IDataProvider<int> dataProvider, TextWriter output)
        {
