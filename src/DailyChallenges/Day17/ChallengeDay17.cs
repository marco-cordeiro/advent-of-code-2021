...
namespace AdventOfCode2020.DailyChallenges.Day17
{
    public class ChallengeDay17 : IAdventCodeDayChallenge
    {
        private readonly IDataProvider<int> _dataProvider;
        private readonly TextWriter _output;

        public ChallengeDay17(IDataProvider<int> dataProvider, TextWriter output)
        {
