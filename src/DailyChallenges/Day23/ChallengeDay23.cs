...
namespace AdventOfCode2020.DailyChallenges.Day23
{
    public class ChallengeDay23 : IAdventCodeDayChallenge
    {
        private readonly IDataProvider<int> _dataProvider;
        private readonly TextWriter _output;

        public ChallengeDay23(IDataProvider<int> dataProvider, TextWriter output)
        {
